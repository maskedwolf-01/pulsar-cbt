...
import { 
  ...
  Award, AlertCircle, X, Calculator, Share2, Search, Info, Home, RefreshCw, User, Lightbulb, Leaf
} from 'lucide-react';
...
export default function ExamPage() {
  ...
  const fetchAndShuffleQuestions = async () => {
    const { data, error } = await supabase
      ...
      .eq('course_code', 'BIO 101'); // BIO 101
            ...
            {currentQ.display_options.map((opt: any, idx: number) => {
              ...
              if (isReviewing) {
                 if (isCorrectOption) {
                  ...
                  if (isSelected) btnClass = "bg-green-600 border-green-600 text-white shadow-lg shadow-green-900/20"; 
              }
